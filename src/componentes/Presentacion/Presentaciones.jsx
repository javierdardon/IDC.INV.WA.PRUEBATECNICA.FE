...
const Presentaciones = () => {
    ...
    useEffect(() => {
        ...
        fetch('https://inv-wspruebatecnica-be.azurewebsites.net/api/Presentacion' )
    ...
    const handleEliminar = (PresentacionId) => {
        ...
        if (window.confirm('¿Estás seguro de que deseas eliminar esta categoría?')) {
            fetch(`https://inv-wspruebatecnica-be.azurewebsites.net/api/Presentacion/${PresentacionId}`, {
                method: 'DELETE'
            })
                .then((response) => {
        ...
        <Container maxWidth="xl">
            <>
                <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 2 }}>
                    <Button variant="contained" color="success" size="large" onClick={agregarPresentacion}>
                ...
                <TablePagination
                    ...
                    component="div"
                    count={filteredPresentaciones.length}
